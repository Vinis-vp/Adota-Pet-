...
import { middlewareValidadorBodyAdotante } from "../middleware/validadores/adotantesRequestBody";
...
router.post(
  ...
  ,
  (req, res) => adotanteController.criaAdotante(req, res)); // Rota para criar um adotante
